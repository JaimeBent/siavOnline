                ...
                <div class="card animate__animated animate__fadeIn">
                    <div class="col-6 col-md-4">
                        <h5 class="text-center">
                            <img class="mr-auto p-3 " width="300px" height= "100px" alt="..." src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/Proyectos/SiavOnline/images/logoSiavOnline.jpeg">
                        </h5> 
